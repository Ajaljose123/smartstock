...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authapp', '0007_rename_staff_bill_created_by_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='role',
            field=models.CharField(choices=[('admin', 'Admin'), ('staff', 'Staff'), ('supplier', 'Supplier')], default='staff', max_length=10),
        ),
